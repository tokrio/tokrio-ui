...
export function PoolData({currentAPY}: {currentAPY: string}) {
    ...
    const getRewardPoolInfo = async () => {
        ...
        const response = await getReadData('getTokrioStakingInfo', TokrioStaking, config.STAKING, [])
    ...
    return <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
            ...
            <CountUpAnimation end={Number(currentAPY)} suffix="%" />
